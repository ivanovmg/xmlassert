...
def assert_xml_equal(actual: str, expected: str) -> None:
    ...
    actual_pretty = _pretty_format_xml(actual)
    expected_pretty = _pretty_format_xml(expected)
...
def _pretty_format_xml(xml_str: str) -> str:
...
# Visitors remain the same as above
